...
private func _createSampleEventManager() -> HSSquareEventManager{
    ...
    let gameStartAction = HSEraEventMoneyAppendAction(title: "ゲーム開始！", appendMoneyCount: 5000)
    ...
    let bubbleAction = HSEraEventMoneyReduceAction(title: "バブル崩壊の影響で資産が減った。￥3000減る。", reduceMoneyCount: 3000)
    ...
    let ozakiAction = HSEraEventMoneyReduceAction(title: "尾崎豊死去の影響で散財しまくった。￥5000失う。", reduceMoneyCount: 5000)
